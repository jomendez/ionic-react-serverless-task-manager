...
import { getUploadUrl, uploadFile } from '../api/profile-api'
...
export class UploadProfileImage extends React.PureComponent<
  UploadImageProps,
  UploadImageState
  > {
  ...
  handleSubmit = async (event: React.SyntheticEvent) => {
    ...
    try {
      ...
      const uploadUrl = await getUploadUrl(this.props.auth.getIdToken(), this.props.match.params.profileId)
